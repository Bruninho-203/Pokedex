...
if (isset($_REQUEST["nom"], $_REQUEST["prenom"], $_REQUEST["pseudo"], $_REQUEST["mdp"], $_REQUEST["email"]) == true) {
    $Nom = $_REQUEST["nom"];
    $_SESSION["nom"] = $Nom;
    ...
    ajout_personne($Nom, $Prenom, $MotDePasse, $Pseudo, $Email, $bdd);
                ...
                <section class="jumbotron">
                    <fieldset>
                        ...
                        <form action="#" method="post">
                            ...
                            <input class="button grow-rotate" type="submit" name="connexion" value="S'inscrire"/>
                        </form>
                    </fieldset>   
                </section>
            </article>
