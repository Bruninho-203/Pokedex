            ...
            <article class="col-md-12 column">
                ...
                <div class="top-buffer col-sm-12">
                    <section class="jumbotron col-sm-10">
                        <header>
                            <h1 style="text-align: center">Dragon</h1>
                        </header>
                        <article>
                            <?php affiche_categorie_Liste(recupere_categorie_Liste($bdd, 6)); ?>
                        </article>
                    </section>
                    ...
                    <section class="col-sm-2">
                        <aside class="row-md-12">
                            <article>
                                <p>Welcome!</p>
                                <p><?php affiche_categorie_aside(recupere_categorie($bdd), 'Dragon') ?></p>
                            </article>
                            <fieldset>
                                <p><?php echo $pseudo; ?></p>                     
                            </fieldset>         
